    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={fetchEvents}
          disabled={loading}
          className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-[#4b2c5e] disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center space-x-2"
        >
          <svg
            className="w-4 h-4"
            fill="none"
                      ...
                      <div className="flex space-x-2">
                        {isRegistered ? (
                          ...
                          <button
                            ...
                            className="flex-1 py-2 bg-blue-600 text-white rounded-md hover:bg-[#4b2c5e] disabled:bg-blue-400 disabled:cursor-not-allowed text-sm flex items-center justify-center"
                          >
                            {isRegistering ? (
                              <>
