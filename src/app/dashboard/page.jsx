...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Tableau de Bord - Algerian Society of Cosmetology</title>
      </Head>
                ...
                <div className="space-y-4">
                  {recentEvents.map((event) => (
                    ...
                    >
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium ${getEventStatusColor(event.status)}`}
                      >
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link
                ...
                className="p-4 border border-gray-200 rounded-lg text-center hover:border-blue-300 hover:bg-[#ddd3e6] transition-colors"
              >
              ...
              <Link
                ...
                className="p-4 border border-gray-200 rounded-lg text-center hover:border-orange-300 hover:bg-orange-50 transition-colors"
              >
              ...
              <Link
                ...
                className="p-4 border border-gray-200 rounded-lg text-center hover:border-purple-300 hover:bg-purple-50 transition-colors"
              >
