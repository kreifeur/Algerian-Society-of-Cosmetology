  ...
  const conversations = [
    {
      ...
      messages: [
        ...
        },
        {
          ...
          sender: "other",
          content:
            "Parfait. Je vous contacte au sujet de notre collaboration sur le nouveau projet de crème hydratante.",
      ...
      messages: [
        {
          ...
          sender: "other",
          content:
            "Salut Marie, as-tu eu le temps de consulter le document que je t'ai envoyé ?",
      ...
      messages: [
        {
          ...
          sender: "other",
          content:
            "Bonjour, je serais intéressé par une collaboration sur votre prochain projet.",
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {activeConv.participant.company}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-t border-gray-200">
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-[#4b2c5e]"
                >
                  Envoyer
                </button>
              </div>
