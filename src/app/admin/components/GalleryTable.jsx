                ...
                <tr key={item._id} className="hover:bg-gray-50">
                    ...
                    <div className="relative group">
                      ...
                      {editingItem === item._id && !uploadingFile ? (
                        <div className="absolute inset-0 bg-black bg-opacity-50 rounded-md flex items-center justify-center">
                          <label className="cursor-pointer text-white text-xs p-1 bg-blue-600 rounded hover:bg-[#4b2c5e]">
                            Changer
                            <input
                              type="file"
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
                      onClick={() =>
                        onToggleMemberOnlyStatus &&
                        onToggleMemberOnlyStatus(item._id, item.isMemberOnly)
                      }
                    ...
                    {editingItem === item._id ? (
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="text-blue-600 hover:text-[#4b2c5e] p-1 hover:bg-[#ddd3e6] rounded disabled:opacity-50 disabled:cursor-not-allowed"
                          title="Modifier"
                          disabled={uploadingFile === item._id}
                        >
                          <svg
