...
export default function EventEditForm({
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow border-2 border-blue-200 mt-4">
      <h4 className="text-lg font-semibold text-[#4b2c5e] mb-4">
      ...
      {uploadProgress > 0 && (
        <div className="mb-4 p-3 bg-[#ddd3e6] text-[#4b2c5e] border border-blue-200 rounded-md">
        ...
        <div>
          ...
          <label
            ...
            className={`block w-full mt-2 px-4 py-2 rounded-md text-center transition-colors cursor-pointer ${
              eventLoading || uploadProgress > 0
                ...
                : "bg-[#ddd3e6] text-[#4b2c5e] hover:bg-blue-100"
            }`}
          >
          ...
          {event?.imgUrl && !imagePreview && (
            <p className="text-xs text-orange-600 mt-1 text-center">
              ⚠️ L'image actuelle sera supprimée si vous n'en sélectionnez pas
              une nouvelle
            </p>
          )}
        </div>
 ...
 */}
        ...
        <div className="flex justify-end space-x-3 pt-4">
          ...
          <button
            type="submit"
            disabled={eventLoading || uploadProgress > 0}
            className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-[#4b2c5e] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center space-x-2"
          >
            {eventLoading && (
