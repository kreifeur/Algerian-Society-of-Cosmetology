...
export default function GalleryTab({
      ...
      setGalleryItems([
        {
          ...
          imgURL:
            "https://res.cloudinary.com/dlr034bds/image/upload/v1/logo.jpg",
          fileUrl:
            "https://res.cloudinary.com/dlr034bds/image/upload/v1/logo.jpg",
          thumbnailUrl:
            "https://res.cloudinary.com/dlr034bds/image/upload/w_300,h_300,c_fill/v1/logo.jpg",
          fileType: "image",
          isMemberOnly: false,
        ...
        },
        {
          ...
          imgURL:
            "https://res.cloudinary.com/dlr034bds/image/upload/v1/event-launch.jpg",
          fileUrl:
            "https://res.cloudinary.com/dlr034bds/image/upload/v1/event-launch.jpg",
          thumbnailUrl:
            "https://res.cloudinary.com/dlr034bds/image/upload/w_300,h_300,c_fill/v1/event-launch.jpg",
          fileType: "image",
          isMemberOnly: true,
          uploadedBy: "68dc23a5a4dc2af908c4f95f",
        ...
        },
        {
          ...
          imgURL:
            "https://res.cloudinary.com/dlr034bds/image/upload/v1/workshop.jpg",
          fileUrl:
            "https://res.cloudinary.com/dlr034bds/image/upload/v1/workshop.jpg",
          thumbnailUrl:
            "https://res.cloudinary.com/dlr034bds/image/upload/w_300,h_300,c_fill/v1/workshop.jpg",
          fileType: "image",
          isMemberOnly: false,
          uploadedBy: "68dc23a5a4dc2af908c4f95f",
        ...
        },
        {
          ...
          imgURL:
            "https://res.cloudinary.com/dlr034bds/video/upload/v1/conference.mp4",
          fileUrl:
            "https://res.cloudinary.com/dlr034bds/video/upload/v1/conference.mp4",
          thumbnailUrl:
            "https://res.cloudinary.com/dlr034bds/video/upload/w_300,h_300,c_fill/v1/conference.jpg",
          fileType: "video",
          isMemberOnly: false,
          uploadedBy: "68dc23a5a4dc2af908c4f95f",
  ...
  const handleUpdateGalleryItem = async (itemId, updates) => {
    try {
      ...
      const isFileUpdate =
        updates.imgURL && updates.fileUrl && updates.thumbnailUrl;
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="p-4 bg-[#ddd3e6] rounded-lg border border-blue-200">
            <h3 className="font-medium text-[#4b2c5e] text-sm">
              Total des Médias
            </h3>
