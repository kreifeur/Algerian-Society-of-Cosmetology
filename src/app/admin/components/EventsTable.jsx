  ...
  return (
    <div className="bg-white rounded-lg shadow">
      <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <button
          onClick={onRefresh}
          className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-[#4b2c5e] transition-colors flex items-center space-x-2 text-sm"
        >
          <svg
            className="w-4 h-4"
            fill="none"
                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="flex flex-wrap gap-1 mt-2">
                                  {event.isOnline && (
                                    <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-[#4b2c5e]">
                                      En ligne
                                    </span>
                                  )}
                                  {event.isMemberOnly && (
                            ...
                            <div className="flex flex-col space-y-2">
                              <div className="flex space-x-2">
                                <button
                                  ...
                                  className="text-blue-600 hover:text-[#4b2c5e] flex items-center space-x-1"
                                >
                                  <svg
                                    className="w-4 h-4"
                                    fill="none"
