...
export default function ContentTab({ stats, setStats }) {
      ...
      const demoArticles = [
        {
          ...
          content:
            "Contenu complet de l'article avec toutes les informations détaillées...",
          excerpt:
            "Découvrez les dernières innovations en cosmétologie pour l'année 2024",
          authorId: {
        ...
        },
        {
          ...
          content:
            "Exploration des avantages des ingrédients naturels en cosmétique...",
  ...
  const updateStats = (articles) => {
    ...
    const memberOnlyArticles = articles.filter(
      (article) => article.isMemberOnly,
    ).length;
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="p-4 bg-[#ddd3e6] rounded-lg">
            <h3 className="font-medium text-[#4b2c5e]">Articles Totaux</h3>
          ...
          <div className="p-4 bg-purple-50 rounded-lg">
            ...
            <p className="text-2xl font-bold">
              {articles.filter((a) => a.isMemberOnly).length}
            </p>
          </div>
        </div>
      </div>
