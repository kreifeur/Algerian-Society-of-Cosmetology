...
export default function MemberCreationModal({ onClose, onMemberCreated }) {
  ...
  const handleCreateMember = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          result.message || "Erreur lors de la création du membre",
        );
      }
 ...
 */}
            ...
            <div className="flex justify-end space-x-4 pt-6">
              ...
              <button
                type="submit"
                disabled={memberLoading}
                className="px-4 py-2 bg-[#4b2c5e] text-white rounded-md hover:bg-[#4b2c5e] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
