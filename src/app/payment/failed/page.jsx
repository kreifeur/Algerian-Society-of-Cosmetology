...
function PaymentFailedContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center p-4">
      <Head>
        <title>Paiement échoué - Algerian Society of Cosmetology</title>
      </Head>
      ...
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
        {loading ? (
          ...
          <>
            ...
            <div className="space-y-4">
              <div className="bg-[#ddd3e6] p-4 rounded-lg border border-blue-100">
                <h4 className="font-semibold text-[#4b2c5e] mb-2 flex items-center">
                  <svg
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  <a
                    ...
                    className="text-center border border-blue-600 text-blue-600 py-2 px-4 rounded-md hover:bg-[#ddd3e6] transition-colors text-sm flex-1"
                  >
                    Par email
                  </a>
                </div>
