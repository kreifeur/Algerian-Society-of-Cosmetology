    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="py-16 px-6">
        <div className="container mx-auto text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-bg-[#4b2c5e] mx-auto mb-4"></div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="py-16 px-6">
        <div className="container mx-auto max-w-md text-center">
          ...
          <h2 className="text-2xl font-bold text-[#4b2c5e] mb-4">
      ...
      <main className="py-16 px-6">
        <div className="container mx-auto max-w-md">
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-[#4b2c5e] mb-6">
            ...
            <div className="mb-8">
              <h3 className="font-semibold text-[#4b2c5e] mb-4">
                Détails de l'inscription :
              </h3>
              <div className="bg-[#ddd3e6] rounded-lg p-6 mb-6 text-left">
            ...
            {selectedPaymentMethod === "cash" ? (
              <div className="bg-[#ddd3e6] p-4 rounded-lg mb-8">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full px-8 py-3 bg-yellow-500 text-[#4b2c5e] rounded-md hover:bg-yellow-400 transition-colors font-medium text-lg"
              >
                Retour aux événements
              </button>
              <Link
                href="/profile"
                className="block w-full px-8 py-3 border border-bg-[#4b2c5e] text-[#4b2c5e] rounded-md hover:bg-[#ddd3e6] transition-colors font-medium text-lg text-center"
              >
      ...
      <main className="py-12 px-4 sm:px-6">
        <div className="container mx-auto max-w-md">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-[#4b2c5e] mb-3">
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div
                className={`flex flex-col items-center ${currentStep >= 1 ? "text-[#4b2c5e]" : "text-gray-400"}`}
              >
                <div
                  className={`h-8 w-8 rounded-full flex items-center justify-center text-sm ${currentStep >= 1 ? "bg-[#4b2c5e] text-white" : "bg-gray-200"}`}
                >
                  1
                </div>
              ...
              <div
                className={`h-1 flex-1 mx-2 ${currentStep >= 2 ? "bg-[#4b2c5e]" : "bg-gray-200"}`}
              ></div>
              <div
                className={`flex flex-col items-center ${currentStep >= 2 ? "text-[#4b2c5e]" : "text-gray-400"}`}
              >
                <div
                  className={`h-8 w-8 rounded-full flex items-center justify-center text-sm ${currentStep >= 2 ? "bg-[#4b2c5e] text-white" : "bg-gray-200"}`}
                >
                  2
                </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            {currentStep === 1 ? (
              <>
                {/* Event Summary */}
                <div className="mb-6">
                  <h2 className="text-xl font-semibold text-[#4b2c5e] mb-4 text-center">
                    Votre inscription
                  </h2>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-[#ddd3e6] rounded-lg p-4 text-center">
                      ...
                      {paymentData.priceType === "member" &&
                        paymentData.nonMemberPrice > paymentData.memberPrice}
                    </div>
                  </div>
                </div>
                ...
                {/* Payment Methods */}
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-[#4b2c5e] mb-3 text-center">
                    Mode de paiement
                  </h3>
                ...
                <div className="flex justify-between pt-4 border-t">
                  ...
                  <button
                    onClick={nextStep}
                    className="px-4 py-2 bg-[#4b2c5e] text-white rounded-md hover:bg-[#4b2c5e] transition-colors text-sm font-medium"
                  >
                    Continuer
                  </button>
                </div>
              ...
              <>
                ...
                <div className="text-center mb-6">
                  <h2 className="text-xl font-semibold text-[#4b2c5e] mb-2">
                ...
                {/* Order Summary */}
                <div className="bg-[#ddd3e6] rounded-lg p-4 mb-6">
                  <h3 className="font-semibold text-[#4b2c5e] mb-3 text-center text-sm">
                    Récapitulatif
                  </h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center pb-2 border-b">
                      <div>
                        ...
                        <span className="text-[#4b2c5e] font-semibold text-sm">
                          {paymentData.eventTitle}
                        </span>
                      </div>
                    ...
                    <div className="pt-3">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          <div className="text-xl font-bold text-[#4b2c5e]">
                            {paymentData.amount} DA
                          </div>
          ...
          <div className="mt-8 text-center">
            ...
            <div className="text-[#4b2c5e] font-medium text-sm">
