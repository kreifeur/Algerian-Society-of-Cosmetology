...
function RegisterSuccessContent() {
  ...
  const fetchUserEmail = async (transactionId) => {
    try {
      const response = await fetch(
        `/api/get-user-email?mdOrder=${transactionId}`,
      );
      if (response.ok) {
        const data = await response.json();
        if (data.email) {
  ...
  const registerUserToEvent = async () => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.message || "Erreur lors de l'inscription à l'événement",
        );
      }
      ...
      console.warn(
        "Registration to event failed but payment was successful. Please contact support.",
      );
    }
  };
  ...
  const handlePrintReceipt = async () => {
    ...
    try {
      ...
      alert(
        "Erreur lors de la génération du PDF pour l'impression. Veuillez réessayer.",
      );
    } finally {
      ...
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        {loading ? (
          <div className="py-16 text-center">
            <div className="animate-spin rounded-full h-16 w-16 border-4 border-[#4b2c5e] border-t-transparent mx-auto mb-6"></div>
            ...
            {mdOrder && (
              <div className="bg-slate-50 p-4 rounded-xl mb-8">
                <p className="text-sm text-slate-600">
                  ...
                  <span className="font-mono font-medium">{mdOrder}</span>
                </p>
              </div>
            )}
          ...
          <>
            <div className="bg-gradient-to-r from-[#4b2c5e] to-bg-[#4b2c5e] px-8 py-12 text-white">
            ...
            <div className="p-8">
              <div className="bg-slate-50 rounded-xl p-6 mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-slate-200">
                    ...
                    <span className="text-2xl font-bold text-[#4b2c5e]">
                      {status?.depositAmount / 100 || "0"} DZD
                    </span>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <button
                  ...
                  className="bg-white border-2 border-[#4b2c5e] text-[#4b2c5e] py-3 px-4 rounded-xl hover:bg-[#ddd3e6] transition-colors flex items-center justify-center gap-2 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
              ...
              <div className="bg-[#ddd3e6] rounded-xl p-6 mb-8">
                <h3 className="font-bold text-[#4b2c5e] mb-3 flex items-center gap-2">
                  <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
                ...
                <ul className="space-y-2 text-[#4b2c5e]">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-[#4b2c5e] rounded-full"></span>
              ...
              <div className="space-y-3">
                <Link
                  href="/login"
                  className="w-full bg-[#4b2c5e] text-white py-3 px-6 rounded-xl hover:bg-[#4b2c5e] transition-colors block text-center font-medium"
                >
