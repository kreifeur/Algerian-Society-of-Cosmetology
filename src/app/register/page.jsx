  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center py-12 px-4">
        <Head>
          <title>Inscription réussie - Algerian Society of Cosmetology</title>
        </Head>
        ...
        <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            Bienvenue à Algerian Society of Cosmetology. Un email de
            confirmation a été envoyé à votre adresse.
          </p>

          <div className="bg-[#ddd3e6] p-4 rounded-lg mb-6 text-left">
          ...
          <div className="space-y-3">
            <Link
              href="/login"
              className="w-full bg-[#4b2c5e] text-white py-2 px-4 rounded-md hover:bg-[#4b2c5e] transition-colors block"
            >
              Se connecter
            </Link>
            <Link
            ...
            <div className="flex justify-between items-center mb-4">
              <div
                className={`flex flex-col items-center ${
                  step >= 1 ? "text-[#4b2c5e]" : "text-gray-400"
                }`}
              >
                <div
                  className={`h-10 w-10 rounded-full flex items-center justify-center ${
                    step >= 1 ? "bg-[#4b2c5e] text-white" : "bg-gray-200"
                  }`}
                >
                  1
                </div>
              ...
              <div
                className={`h-1 flex-1 mx-2 ${
                  step >= 2 ? "bg-[#4b2c5e]" : "bg-gray-200"
                }`}
              ></div>
              <div
                className={`flex flex-col items-center ${
                  step >= 2 ? "text-[#4b2c5e]" : "text-gray-400"
                }`}
              >
                <div
                  className={`h-10 w-10 rounded-full flex items-center justify-center ${
                    step >= 2 ? "bg-[#4b2c5e] text-white" : "bg-gray-200"
                  }`}
                >
                  2
                </div>
              ...
              {step === 1 && (
                <>
                  ...
                  <button
                    type="button"
                    onClick={nextStep}
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#4b2c5e] hover:bg-[#4b2c5e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
                    Continuer
                  </button>
                </>
                ...
                <>
                      ...
                      {membershipTypes.map((type) => (
                        ...
                        >
                          <div className="flex items-start justify-between">
                            ...
                            <span className="text-lg font-semibold text-[#4b2c5e]">
                              {type.price}
                            </span>
                          </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#4b2c5e] hover:bg-[#4b2c5e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
                    >
                      {isLoading
