...
export default function Login() {
          ...
          if (profileData.success) {
            ...
            if (fullUserData._id || fullUserData.userId) {
              localStorage.setItem(
                "userId",
                fullUserData._id || fullUserData.userId,
              );
            }
            ...
            console.warn(
              "API profile non disponible, utilisation des données de base",
            );
          }
        } catch (profileError) {
          console.error(
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      <Head>
        <title>Connexion - Algerian Society of Cosmetology</title>
        <meta
          name="description"
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="mt-6 p-4 bg-[#ddd3e6] rounded-md border border-blue-100">
              ...
              <div className="space-y-3">
                <div>
                  <h4 className="text-xs font-semibold text-[#4b2c5e] mb-1">
                    Membre
                  </h4>
