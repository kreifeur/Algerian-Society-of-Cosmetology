...
function RegisterSuccessContent() {
  ...
  const getReceiptContent = () => {
    return (
      <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
        {/* En-tête du reçu */}
        <div className="text-center border-b-2 border-bg-[#4b2c5e] pb-4 mb-4">
          <h1 className="text-xl font-bold text-[#4b2c5e]">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between py-2 border-b border-gray-200">
            ...
            <span className="font-bold text-[#4b2c5e]">
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="text-center mt-4 no-print">
          <button onclick="window.print()" class="bg-[#4b2c5e] text-white px-4 py-2 rounded">
            Imprimer
          </button>
        </div>
        <script>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4">
      <Head>
        <title>Paiement réussi - Algerian Society of Cosmetology</title>
      </Head>

      <div className="max-w-2xl w-full bg-white p-8 rounded-lg shadow-md">
        {loading ? (
          <div className="py-8 text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-bg-[#4b2c5e] mx-auto mb-4"></div>
          ...
          <>
            ...
            <div className="bg-[#ddd3e6] p-6 rounded-lg mb-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-lg text-[#4b2c5e]">
                  Reçu de paiement
                </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
                <button
                  ...
                  className="bg-[#4b2c5e] text-white py-3 px-4 rounded-md hover:bg-[#4b2c5e] transition-colors flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
            ...
            <div className="bg-[#ddd3e6] p-4 rounded-lg mb-8 text-left">
            ...
            <div className="space-y-3 mt-8">
              <Link
                href="/login"
                className="w-full bg-[#4b2c5e] text-white py-3 px-4 rounded-md hover:bg-[#4b2c5e] transition-colors block text-center"
              >
