...
export default function Events() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head>
        <title>Événements - Algerian Society of Cosmetology</title>
        <meta
          name="description"
      ...
      <main className="flex-grow bg-[#ddd3e6] py-12">
        <div className="container mx-auto px-4">
                    ...
                    <div className="p-6">
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          ...
                          <h3 className="text-xl font-semibold text-[#4b2c5e] mb-1 line-clamp-1">
                            {event.title}
                          </h3>
                        </div>
          ...
          <div className="text-center">
            <button
              ...
              className="px-6 py-2 bg-blue-100 text-[#4b2c5e] rounded-md hover:bg-blue-200 transition-colors text-sm font-medium"
            >
              🔄 Rafraîchir la liste
            </button>
          </div>
