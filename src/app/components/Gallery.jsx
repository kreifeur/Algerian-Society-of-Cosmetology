...
const Gallery = () => {
  ...
  if (isLoading) {
    return (
      <section className="py-16 px-6 bg-[#ddd3e6] text-center">
        Chargement…
      </section>
    );
  }
  ...
  return (
    <section id="gallery" className="py-16 px-6 bg-[#ddd3e6]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {galleryItems.map((item) => {
              ...
              return (
                ...
                >
                  {item.isMemberOnly && (
                    <div className="absolute top-2 right-2 z-10 bg-[#4b2c5e] text-white text-xs px-2 py-1 rounded">
                      Membres
                    </div>
                  )}
