...
const Events = () => {
  ...
  const getEventStatus = (status) => {
    switch (status) {
      ...
      case "available":
        return { text: "Disponible", color: "bg-blue-100 text-[#4b2c5e]" };
      case "pending":
        ...
        {events.length === 0 ? (
          ...
          <>
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex flex-col items-end space-y-1">
                          ...
                          {event.isOnline && (
                            <span className="px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-[#4b2c5e]">
                              En ligne
                            </span>
                          )}
                          {!isFreeEvent && (
                      ...
                      <h3 className="font-semibold text-lg mb-2 line-clamp-2 text-[#4b2c5e]">
                        {event.title}
                      </h3>
                      ...
                      <div className="flex space-x-2">
                        {isRegistered ? (
                          ...
                          <button
                            ...
                            className="flex-1 py-2 bg-[#4b2c5e] text-white rounded-md hover:bg-[#4b2c5e] disabled:bg-gray-400 disabled:cursor-not-allowed text-sm flex items-center justify-center"
                          >
                            {isRegistering ? (
                              <>
                        ...
                        <button
                          ...
                          className="px-3 py-2 border border-bg-[#4b2c5e] text-[#4b2c5e] rounded-md hover:bg-[#ddd3e6] text-sm"
                        >
                          Détails
                        </button>
                      </div>
            ...
            <div className="text-center mt-10">
              <Link
                href="/events"
                className="px-6 py-3 bg-[#4b2c5e] text-white rounded-md hover:bg-[#4b2c5e] transition-colors font-medium"
              >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-sm w-full p-6">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#4b2c5e] mb-4">
                Connexion requise
              </h3>
              ...
              <div className="flex justify-center space-x-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#4b2c5e] text-white rounded-md hover:bg-[#4b2c5e] transition-colors"
                >
                  Se connecter
                </button>
              </div>
