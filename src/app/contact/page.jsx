...
export default function Contact() {
  ...
  return (
    <div>
      <Head>
        <title>Contact - Algerian Society of Cosmetology</title>
        <meta
          name="description"
          content="Contactez l'Association de Cosmétologie pour toute question ou demande d'information"
        />
      ...
      <main className="min-h-screen bg-[#ddd3e6] py-12">
        <div className="container mx-auto px-4">
              ...
              {isSubmitted && (
                <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg mb-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      <strong>Merci pour votre message !</strong> Nous vous
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-[#4b2c5e] text-white py-3 px-6 rounded-md hover:bg-[#4b2c5e] transition-colors font-medium disabled:bg-blue-400 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {isLoading ? (
                      <>
                ...
                <p className="text-xs text-gray-500 text-center">
                  En soumettant ce formulaire, vous acceptez que nous traitions
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="bg-blue-100 p-3 rounded-full mr-4">
                      <span className="text-[#4b2c5e] text-xl">📍</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="bg-blue-100 p-3 rounded-full mr-4">
                      <span className="text-[#4b2c5e] text-xl">✉️</span>
                    </div>
                    <div>
          ...
          {/* <div className="mt-16">
            <h2 className="text-2xl font-semibold text-center text-[#4b2c5e] mb-6">Notre localisation</h2>
          ...
          {/* FAQ */}
          <div className="mt-16">
            <h2 className="text-2xl font-semibold text-center text-[#4b2c5e] mb-6">
