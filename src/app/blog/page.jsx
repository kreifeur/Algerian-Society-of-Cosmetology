      ...
      <main className="min-h-screen bg-[#ddd3e6] py-12">
        <div className="container mx-auto px-4">
          ...
          <section className="w-full mb-8 text-center">
            <h1 className="text-4xl font-bold text-[#4b2c5e] mb-4">Blog</h1>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
             Accédez à des analyses, des actualités et des éclairages d’experts en cosmétologie.
          ...
          <section className="w-full max-w-5xl mx-auto mb-12">
            <div className="flex sm:flex-row flex-col gap-4 items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-2">
                <BiSolidCategory className="text-[#4b2c5e]" />
                <select
                    ...
                    >
                      ...
                      <div className="p-6">
                        <div className="flex justify-between items-center mb-3">
                          <span className="px-3 py-1 bg-[#4b2c5e] text-white rounded-full text-sm">
                            {post.category}
                          </span>
                        ...
                        <h3 className="font-semibold text-xl text-[#4b2c5e] mb-2 line-clamp-2">
                          {post.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                              <span className="text-[#4b2c5e] text-sm font-semibold">
          ...
          <section className="w-full max-w-8xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-center text-[#4b2c5e] mb-6">
              Articles Populaires
            </h2>
              ...
              {popularPosts.map((post) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="font-semibold text-lg text-[#4b2c5e] mt-2 mb-1 line-clamp-2">
                      {post.title}
                    </h3>
