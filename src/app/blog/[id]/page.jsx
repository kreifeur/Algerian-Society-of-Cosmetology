...
export default function BlogPost() {
        ...
        <main className="min-h-screen bg-[#ddd3e6] py-12">
          <div className="container mx-auto px-4">
            <div className="text-center py-12">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-bg-[#4b2c5e] mx-auto"></div>
      ...
      <div>
        ...
        <main className="min-h-screen bg-[#ddd3e6] py-12">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-2xl font-bold text-[#4b2c5e] mb-4">
              Article non trouvé
            </h1>
  ...
  return (
    <div>
      <Head>
        <title>
          {selectedPost.title} - Blog Algerian Society of Cosmetology
        </title>
      ...
      <main className="min-h-screen bg-[#ddd3e6] py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="w-full py-4">
            <Link
              href="/blog"
              className="flex items-center gap-2 text-[#4b2c5e] font-medium hover:text-blue-600 transition-colors"
            >
          ...
          <article className="w-full max-w-4xl mx-auto py-8">
            ...
            <div className="mb-6 flex flex-wrap gap-2">
              {selectedPost.tags.map((tag, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-[#4b2c5e] text-white rounded-full text-sm"
                >
                  {tag}
                </span>
              ))}
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-[#4b2c5e] mb-4">
              {selectedPost.title}
            </h1>
            ...
            {relatedPosts.length > 0 && (
              <div className="mt-12 pt-8 border-t border-gray-200">
                <h3 className="text-xl font-semibold mb-6 text-[#4b2c5e]">
                  Articles similaires
                </h3>
                  ...
                  {relatedPosts.map((post) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <h4 className="font-semibold text-lg text-[#4b2c5e] mt-2 mb-1 line-clamp-2">
                          {post.title}
                        </h4>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <h3 className="text-xl font-semibold mb-4 text-[#4b2c5e]">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Passionné par l'innovation pharmaceutique, il contribue au
                    développement de solutions modernes pour la santé.
                  </p>
                </div>
              </div>
            </div>
